...
class TestController < ApplicationController
  # GET /test_money_send
    ...
    def simplify_create
=begin
        Simplify::public_key = "sbpb_N2MzYTBhOTAtMmJiZC00NWMyLTgzZDQtMDQ4MmRhYzhkZmU2"
        Simplify::private_key = "/KpT2hAGQnvJtkzS/drT4N3qUrNP5q9XYWE3LnDj3Th5YFFQL0ODSXAOkNtXTToq"
         
        payment = Simplify::Payment.create({
                "amount" => "1000",
                "token" => params[:simplifyToken],
                "description" => "Test Simplify",
...
#    amount=5000&
#    paymentId=ddg4M6bG&
#    paymentDate=1420552883439&
#    paymentStatus=APPROVED&
#    authCode=5e6LRN&
#    currency=USD&
#    signature=CE7851CA4C6F4FB23F07F4A155324229&
#    reference=REF123
